...
namespace Destructible2D
{
    ...
    public class D2dSplitter : MonoBehaviour
    {
        ...
        public int Feather { set { feather = value; } get { return feather; } }
        [SerializeField] private int feather = 3;
        ...
        public int HealThreshold { set { healThreshold = value; } get { return healThreshold; } }
        [SerializeField] private int healThreshold = -1;
        ...
        public static List<D2dDestructible> pieceDestructibleList { get; private set; }

        public void ClearPiece()
        {
            Debug.Log($"{this.name} Clear piece");
            foreach (var peice in pieceDestructibleList)
            {
                Destroy(peice.gameObject);
            }
            pieceDestructibleList.Clear();
        }

        private void Awake()
        {
            pieceDestructibleList = new List<D2dDestructible>();
        }
